...
public final class InjectionTest {
  ...
  @Test public void unusedProvidesMethod_whenModuleNonStrict() throws Exception {
    class EntryPoint {}
    class BagOfMoney {}
    @Module(entryPoints = EntryPoint.class, strict = false)
    class TestModule {
  ...
  @Test public void unusedProviderMethod_whenModuleStrict() throws Exception {
    class EntryPoint {}
    class BagOfMoney {}
    @Module(entryPoints = EntryPoint.class, strict = true)
    class TestModule {
      @Provides BagOfMoney providesMoney() {
        return new BagOfMoney();
      }
  ...
  @Test public void unusedOptionalProvidesMethod() throws Exception {
    class EntryPoint {}
    class BagOfMoney {}
    @Module(entryPoints = EntryPoint.class)
    class TestModule {
      @Provides @Optional BagOfMoney providesMoney() {
        return new BagOfMoney();
      }
    }
  ...
  @Test public void unusedProvidesMethodModule() throws Exception {
    class EntryPoint {}
    class BagOfMoney {}
    @Module(entryPoints = EntryPoint.class, strict = false)
    class TestModule {
